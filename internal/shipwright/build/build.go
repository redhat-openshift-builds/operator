...
// Create creates v1alpha1.ShipwrightBuild object
func (sb *ShipwrightBuild) Create(ctx context.Context, owner client.Object) error {
	...
	return sb.Client.Create(ctx, object)
}
