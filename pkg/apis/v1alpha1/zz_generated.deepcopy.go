...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SharedResourceState) DeepCopyInto(out *SharedResourceState) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SharedResourceState.
func (in *SharedResourceState) DeepCopy() *SharedResourceState {
	if in == nil {
		return nil
	}
	out := new(SharedResourceState)
